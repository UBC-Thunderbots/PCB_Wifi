...
This repository contains Altium PCB files for UBC Thunderbots' wifi pcb. Anyone who wishes to push changes to this project must get permission from the current Electrical Team Lead.
...
2. **Recursively clone** (`git clone --recurse-submodules`) your working branch of the repository to your PC (i.e. `C:/Documents/thunderbots/PCB_Wifi`).
...
---|---
Name|PCB_Wifi
Default Checkout Path|location of local repository (i.e. `C:/Documents/thunderbots/PCB_Wifi`)
Method|https
Server|github.com
Server Port|Default
Repository Subfolder|/UBC-Thunderbots/PCB_Wifi
...
`wifi-v1.0/`), `archive/`, and `Altium_Libraries/`. Any previous versions should be placed in `archive/`. Every board revision directory should abide by the following structure:
